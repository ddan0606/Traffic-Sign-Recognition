...
Original file is located at
    https://colab.research.google.com/drive/1X48v8v0zj0oDUXwfmSo4_lWILD9eEGvA
...
outputs = add_classification_layer(resnet_50, num_classes)

resnet_50 = tf.keras.models.Model(inputs = resnet_50.input, outputs = outputs)

resnet_50.compile(optimizer = tf.keras.optimizers.Adam(),
                  loss = 'categorical_crossentropy',
                  metrics = ['accuracy'])

resnet_50.summary()

visualkeras.layered_view(resnet_50, to_file = '/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model_Architecture/resnet_50.png', legend = True)

filepath = "/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/resnet_50.h5"
...
history = resnet_50.fit(train_datagen,
                        epochs = epochs,
                        validation_data = valid_datagen,
                        callbacks = callbacks_list)

resnet_50.save("/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/resnet_50.h5")

loss, accuracy = resnet_50.evaluate(test_datagen)
...
model = tf.keras.models.load_model('/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/resnet_50.h5')
