...
Original file is located at
    https://colab.research.google.com/drive/15iLdPYZ-W4og3cBgNIJAF3i0wCrhMe4N
...
outputs = add_classification_layer(inception_v3, num_classes)

inception_v3 = tf.keras.models.Model(inputs = inception_v3.input, outputs = outputs)
...
tf.keras.utils.plot_model(inception_v3, to_file = '/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model_Architecture/inception.png', show_shapes = True, show_layer_names = True)

filepath = "/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/inception_v3.h5"
...
history = inception_v3.fit(train_datagen,
                           epochs = epochs,
                           validation_data = valid_datagen,
                           callbacks = callbacks_list)

inception_v3.save("/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/inception_v3.h5")

loss, accuracy = inception_v3.evaluate(test_datagen)
...
model = tf.keras.models.load_model('/content/drive/MyDrive/4th/Deep Learning/Project/Deep Learning/model/inception_v3.h5')
